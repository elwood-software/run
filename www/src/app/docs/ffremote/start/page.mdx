...
Once the execution has finished successfully, you can use the `get` command to download the results of the execution. Any output files will be included in the output.
