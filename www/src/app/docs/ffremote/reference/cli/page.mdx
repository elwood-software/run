...
- [ffremote create](#create) - Ask our AI robot to generate an FFmpeg command for you
...
# Examples
ffremote create "clip of input.mov to 60 seconds and add a 3 second in and out fade"
```
